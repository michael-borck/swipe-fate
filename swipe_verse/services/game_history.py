...
class GameHistory:
    ...
    def __init__(self):
        ...
        self.achievements = {
            "resource_master": {
                ...
                "icon": "🏆",
                "conditions": lambda state: any(val >= 90 for val in state.resources.values()),
                "unlocked": False
            },
            "balanced_ruler": {
                "name": "Balanced Ruler",
                ...
                "icon": "⚖️",
                "conditions": lambda state: all(40 <= val <= 60 for val in state.resources.values()),
                "unlocked": False
            },
            "speed_runner": {
                "name": "Speed Runner",
    ...
    def _save_achievements(self) -> None:
        ...
        unlocked = {ach_id: ach["unlocked"] for ach_id, ach in self.achievements.items()}
        
        with open(achievements_file, "w") as f:
            json.dump(unlocked, f, indent=2)
    
    def record_game(self, game_state: GameState, won: bool, win_message: str = "") -> Dict[str, Any]:
        """
        ...
        game_record = {
            ...
            "theme": game_state.theme.name if hasattr(game_state.theme, "name") else "Unknown",
    ...
    def _check_achievements(self, game_state: GameState, won: bool) -> List[Dict[str, Any]]:
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        average_turns = sum(game["turns"] for game in completed_games) / len(completed_games) if completed_games else 0
